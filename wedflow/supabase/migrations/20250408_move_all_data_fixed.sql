...
-- Wedding profile: can't update because unique constraint exists
-- Instead, delete the old one (keep the new one created during onboarding)
DELETE FROM wedding_profiles WHERE couple_id = '31def40a-9c51-4a50-a0e2-42aa55c1f62f';
