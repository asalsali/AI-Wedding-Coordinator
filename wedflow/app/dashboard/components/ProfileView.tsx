...
export function ProfileView({ profile, phoneNumber, onProfileUpdate }: ProfileViewProps) {
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 20, marginBottom: 28 }}>
        ...
        <div style={{ background: 'var(--wf-paper)', border: '1px solid var(--wf-line)', borderRadius: 20, padding: '28px 32px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 10 }}>
            ...
            <span className="wf-serif" style={{ fontSize: 32, fontWeight: 600, color: 'var(--wf-forest)' }}>{profile.readiness_score}%</span>
          </div>
