  ...
  return (
    <DashboardClient
      couple={{
        ...
        subscription_status: (couple.subscription_status as string | null) ?? null,
        usage_streak_weeks: (couple.usage_streak_weeks as number) ?? 0,
        churn_status: (couple.churn_status as string) ?? 'active',
      }}
      profile={
        p
          ? {
